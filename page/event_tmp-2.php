...
<section class="l-spacer -medium -both">
	<div class="l-container--primary">
		<article class="l-contents">
			...
			<div class="">
				<p>雨の日はお気に入りの傘をさして、お出かけしませんか。足元は軽快な長靴で。梅雨ならではの楽しみです。</p>
			</div>
		</article>
	</div>
</section>
...
<section class="c-bg-yellow l-contents-block__wrap">
	<div class="l-contents-block c-bg-white">
		<div class="l-contents-block__inner">
			...
			<div class="l-container--primary">
				<div class="">
					<p class="p-post-card__cat">軽井沢アンブレラスカイ</p>
					<h3 class="p-post-card__title">雨の日も楽しくなる傘と長靴</h3>
					<dl class="">
							<dt>期間</dt>
