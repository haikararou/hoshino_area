	...
	<div class="l-container--primary-s">
		<article class="l-contents">
			...
			<ul class="c-list-kome">
				<li class="c-list-kome__item">ご宿泊・ご婚礼につきましては以下よりお問い合わせください<br><a href="https://hoshinoresorts.com/ja/hotels/hoshinoyakaruizawa/" target="_blank" class="c-text-underline">星のや軽井沢</a>　｜　<a href="https://www.blestoncourt.com/" target="_blank" class="c-text-underline">軽井沢ホテルブレストンコート</a>　｜　<a href="https://www.hoshinoresorts.com/resortsandhotels/omobeb/beb/5karuizawa.html" target="_blank" class="c-text-underline">BEB5軽井沢</a>　</li>
