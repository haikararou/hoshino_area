	...
	<div class="l-container--primary-s">
		<article class="l-contents">
			...
			<ul class="c-list-kome">
				<li class="c-list-kome__item">ご宿泊・ご婚礼につきましては以下よりお問い合わせください<br><a href="https://hoshinoresorts.com/ja/hotels/hoshinoyakaruizawa/" target="_blank">星のや軽井沢</a>　｜　<a href="https://www.blestoncourt.com/" target="_blank">軽井沢ホテルブレストンコート</a>　｜　<a href="https://www.hoshinoresorts.com/resortsandhotels/omobeb/beb/5karuizawa.html" target="_blank">BEB5軽井沢</a>　</li>
				<li class="c-list-kome__item">団体バスでのご利用は<a href="<?php echo home_url('/facility-guide/bus'); ?>">こちら</a></li>
				<li class="c-list-kome__item">※採用についてのお問合せは<a href="<?php echo home_url('/area-recruit'); ?>">こちら</a></li>
